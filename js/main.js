...
function checkever(){
  ...
  if (!isScrolledIntoView(elementTarget) ) {
      hideTop = 1; //hide top if dominance bar not showing
  }
...
function checkmen(){
  ...
  if(fixpos == 1){
	  ...
	  $(".fixorder").css('position','fixed'); 
	  if ($(window).width() < 970) {
		$(".newtablr").css('margin-top',($(".wrapper").height() + $("#gads").height() + $("#gads2").height() + 11)*-1); 
		$(".fixorder").css('margin-top',($(".wrapper").height() + $("#gads").height() + $("#gads2").height()  + 11)*-1); 
		$(".tablecellttun").css('margin-top',($(".wrapper").height() + $("#gads").height() + $("#gads2").height()  + 11)*-1); 
	  
	  }
	  else{
		$(".newtablr").css('margin-top',($("#imgtop").height() + $("#cryptinflun").height() + $("#tabletitle").height() + $(".wrapper").height() + $("#gads").height() + $("#gads2").height()  + 11)*-1); 
		$(".fixorder").css('margin-top',($("#imgtop").height() + $("#cryptinflun").height() + $("#tabletitle").height() + $(".wrapper").height() + $("#gads").height() + $("#gads2").height()  + 11)*-1); 
		$(".tablecellttun").css('margin-top',($("#imgtop").height() + $("#cryptinflun").height() + $("#tabletitle").height() + $(".wrapper").height() + $("#gads").height() + $("#gads2").height()  + 11)*-1); 
